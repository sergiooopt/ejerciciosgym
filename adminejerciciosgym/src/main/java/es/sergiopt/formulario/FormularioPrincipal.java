...
public class FormularioPrincipal extends javax.swing.JFrame {
    ...
    private void reiniciarCamposEjercicio() {
    ...
    private void reiniciarCamposMusculosInvolucrados() {
    ...
    private void initComponents() {
        ...
        lbDescripcionEjercicio.setMaximumSize(new java.awt.Dimension(80, 18));
        lbDescripcionEjercicio.setMinimumSize(new java.awt.Dimension(80, 18));
        lbDescripcionEjercicio.setPreferredSize(new java.awt.Dimension(80, 18));
        ...
        pnlEjercicioLayout.setHorizontalGroup(
            ...
            .addGroup(pnlEjercicioLayout.createSequentialGroup()
                ...
                .addGroup(pnlEjercicioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlEjercicioLayout.createSequentialGroup()
                        .addGroup(pnlEjercicioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblNombreEjercicio, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lbDescripcionEjercicio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(pnlEjercicioLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtPesoMinimo, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
                        .addComponent(lblPesoMaximo)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtPesoMaximo, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)))
                .addGap(20, 20, 20))
        );
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlMusculosLayout.createSequentialGroup()
                ...
                .addGroup(pnlMusculosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlMusculosLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtActivacionEjMusculo, javax.swing.GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(pnlMusculosLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlMusculosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlMusculosLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(lblEsInvolucrado, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        txtaDetallesEjercicio.setRows(20);
        txtaDetallesEjercicio.setTabSize(5);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(pnlEjercicio, javax.swing.GroupLayout.DEFAULT_SIZE, 144, Short.MAX_VALUE)
                        .addGap(30, 30, 30)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(pnlMusculos, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnGuardarFormulario))
                    .addComponent(spDetallesEjercicio, javax.swing.GroupLayout.DEFAULT_SIZE, 207, Short.MAX_VALUE))
                .addGap(30, 30, 30))
        );
    ...
    private void btnGuardarEjMusculoActionPerformed(java.awt.event.ActionEvent evt) {
        if (cbMusculos.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(this, "Debe seleccionar un músculo");
            return;
        }
        ...
        try {
            ...
            if ((activacion == null || activacion.isEmpty())
                    || (Integer.parseInt(activacion) < 0 || Integer.parseInt(activacion) > 100))
        ...
        if (musculosInvolucrados.stream().anyMatch(e -> e.getIdMusculo().equals(musculoSeleccionado.getIdMusculo()))) {
            musculosInvolucrados.removeIf(e -> e.getIdMusculo().equals(musculoSeleccionado.getIdMusculo()));
            musculosInvolucrados.add(new EjercicioMusculo(null, musculoSeleccionado.getIdMusculo(), descripcion,
                    btnSiEsDirectoEjMusculo.isSelected(), Integer.valueOf(activacion)));
    ...
    private void actualizarFormulario(Ejercicio ejercicio, int filaSeleccionada) throws Exception {
        ...
        for (EjercicioMusculo musculoInvolucrado : musculosInvolucrados) {
            // INSERTAR
            if (!musculosInvolucradosBd.stream()
                    .anyMatch(e -> e.getIdMusculo().equals(musculoInvolucrado.getIdMusculo()))) {
                musculoInvolucrado.setIdEjercicio(ejercicio.getIdEjercicio());
                EjercicioMusculosService.add(musculoInvolucrado);
                // ACTUALIZAR
            } else
                EjercicioMusculosService.update(ejercicio.getIdEjercicio(), musculoInvolucrado.getIdMusculo(),
                        musculoInvolucrado);
        }

        // ELIMINAR
        for (EjercicioMusculo musculoInvolucradoBd : musculosInvolucradosBd) {
            if (!musculosInvolucrados.stream()
                    .anyMatch(e -> e.getIdMusculo().equals(musculoInvolucradoBd.getIdMusculo())))
    ...
    private void btnGuardarFormularioActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            Integer pesoMinimo = txtPesoMinimo.getText().matches("^[0-9]+$") ? Integer.valueOf(txtPesoMinimo.getText())
                    : null;
            Integer pesoMaximo = txtPesoMaximo.getText().matches("^[0-9]+$") ? Integer.valueOf(txtPesoMaximo.getText())
                    : null;

            Ejercicio ejercicio = new Ejercicio(null, txtNombreEjercicio.getText(), txtDescripcionEjercicio.getText(),
                    txtImagen.getText(), pesoMinimo, pesoMaximo);
            ...
            reiniciarCamposEjercicio();
            reiniciarCamposMusculosInvolucrados();
            modificarVistaComponentesMusculo(false);
            musculosInvolucrados = new ArrayList<>();
            ...
            JOptionPane.showMessageDialog(this,
                    "Ha ocurrido algún error desconocido al intentar guardar el formulario");
    ...
    private void btnEliminarEjercicioActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (opcion == JOptionPane.YES_OPTION) {
            ...
            if (idEjercicio != null) {
                ...
                // No se reinicia formulario porque puede estar seleccionado otro ejercicio, se
                // recarga tabla para reflejar eliminación
    ...
    private void cbMusculosItemStateChanged(java.awt.event.ItemEvent evt) {// GEN-FIRST:event_cbMusculosItemStateChanged
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            if (tblEjercicios.getSelectedRow() < 0)
                return;
            ...
            if (idEjercicio != null) {
                if (musculosInvolucrados.stream()
                        .anyMatch(e -> e.getIdMusculo().equals(musculoSeleccionado.getIdMusculo()))) { // comprueba si
                                                                                                       // en lista algún
                                                                                                       // idMusculo ==
                                                                                                       // idMusculo
                    EjercicioMusculo ejercicioMusculoSeleccionado = EjercicioMusculosService.get(idEjercicio,
                            musculoSeleccionado.getIdMusculo());
                    btnSiEsInvolucrado.setSelected(true);
                    modificarVistaComponentesMusculo(true);

                    txtDescripcionEjMusculo.setText(ejercicioMusculoSeleccionado.getDescripcion());
                    txtActivacionEjMusculo
                            .setText(String.valueOf(ejercicioMusculoSeleccionado.getPorcentajeActivacion()));
                    ...
                    // Si músculo seleccionado no está en lista de involucrados
                } else {
                    reiniciarCamposMusculosInvolucrados();
                    modificarVistaComponentesMusculo(false);
                }
    ...
    private void tblEjerciciosMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_tblEjerciciosMouseClicked
        ...
        if (evt.getClickCount() == 1) {
            ...
            for (int i = 0; i < musculos.size(); i++) {
                EjercicioMusculo ejercicioMusculo = EjercicioMusculosService.get(idEjercicio,
                        musculos.get(i).getIdMusculo());
                ...
                sb.append("    - Descripción de la relación: ").append(ejercicioMusculo.getDescripcion()).append("\n");
                sb.append("    - Es directo: ").append(ejercicioMusculo.getEsDirecto() ? "Sí" : "No").append("\n");
                sb.append("    - Porcentaje de activación: ").append(ejercicioMusculo.getPorcentajeActivacion()).append("%\n");
            }
        ...
        if (evt.getClickCount() == 2) {
            ...
            txtPesoMinimo.setText(ejercicio.getPesoMinimo() != null && ejercicio.getPesoMinimo() != 0
                    ? String.valueOf(ejercicio.getPesoMinimo())
                    : "");
            txtPesoMaximo.setText(ejercicio.getPesoMaximo() != null && ejercicio.getPesoMaximo() != 0
                    ? String.valueOf(ejercicio.getPesoMaximo())
                    : "");
